    ...
    <main className="relative min-h-screen bg-white font-body">
      ...
      <section className="py-20 bg-white">
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center max-w-4xl mx-auto">
            <h2 className="text-3xl md:text-4xl font-primary text-black-500 mb-6 font-medium">
              {pageData.introTitle}
            </h2>
            <h3 className="text-3xl md:text-4xl font-primary text-secondary mb-10 font-medium italic">
      ...
      <section className="relative h-[300px] md:h-[400px] w-full overflow-hidden flex items-center justify-center">
        ...
        <div className="relative z-10 text-center px-4">
          <h2 className="text-4xl md:text-6xl font-primary text-white leading-tight">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-12 mt-20">
              {events.map((service) => (
                <div key={service.id} className="flex flex-col">
                  ...
                  <h3 className="text-2xl font-primary text-secondary mb-4 font-medium">
                    {service.title}
                  </h3>
